    ...
    <tr>
      ...
      <td>
        ${d.unread_port_logs > 0 
          ...
          : `<div style="display:inline-flex; align-items:center; gap:5px; background:rgba(16,185,129,0.15); color:#6ee7b7; padding:4px 10px; border-radius:20px; font-weight:600; font-size:11px; border:1px solid rgba(16,185,129,0.3); white-space:nowrap;"><span style="font-size:12px;">✅</span> Aman</div>`}
      </td>
